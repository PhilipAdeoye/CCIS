...
namespace CCMvc.ViewModels
{
    ...
    #region DataTablesParameterModel
    /// <summary>
    /// Class that encapsulates the parameters sent by the jQuery DataTables plugin
    /// </summary>
    ...
    public sealed class DataTablesOrderDirection
    {
